...
/*   Updated: 2023/08/21 17:41:10 by pgorner          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define POLLTIME 500 
    ...
    struct ClientData {
        ...
        ClientData(int client_socket, bool pwdAccepted, bool cap, bool auth, std::string mode) : fd(client_socket), passwordAccepted(pwdAccepted), cap(cap), auth(auth), mode(mode) {}
    };
